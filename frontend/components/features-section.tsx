  ...
  return (
    <div className="relative z-20 mx-auto max-w-7xl py-10 lg:py-40">
      ...
      <div className="relative">
        <div
          className="mt-12 grid grid-cols-1 rounded-md lg:grid-cols-6 xl:border dark:border-neutral-800 opacity-0 animate-in fade-in duration-500 fill-mode-forwards" style={{ animationDelay: '200ms', opacity: 1 }}>
